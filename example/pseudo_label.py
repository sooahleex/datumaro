...
# label_hashkeys = [np.unpackbits(explorer._get_hash_key_from_text_query(label).hash_key, axis=-1) for label in labels]
...
# result = dm_dataset.transform("update_annotations", label_hashkeys=label_hashkeys, explorer=explorer)
