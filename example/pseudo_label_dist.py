...
# # 새로운 defaultdict에 180개의 랜덤 item을 저장
...
#     items.append(
#         DatasetItem(id=train_item.id, subset=train_item.subset,
#                     media=train_item.media, annotations=[Label(label)])
#     )

# for label, val_items in val_result.items():
# for val_item in val_items:
#     items.append(
#         DatasetItem(id=val_item.id, subset=val_item.subset,
#                     media=val_item.media, annotations=[Label(label)])
#     )
